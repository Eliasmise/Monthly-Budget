  ...
  return (
    <Card className="w-full max-w-md border-white/60 bg-card/90 backdrop-blur-sm">
      <CardHeader>
        ...
        <CardDescription>Use your username and password to access your dashboard.</CardDescription>
      </CardHeader>
      <CardContent>
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <Button className="w-full" disabled={loading || username.trim().length === 0 || password.length === 0} type="submit">
